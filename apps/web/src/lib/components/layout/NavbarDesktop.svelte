      ...
      {#if props.settings?.socialLinks?.linkedin}
        <li class="h-full">
          <a
            ...
            class="flex items-center h-full px-4 pr-6 rounded-r-xl text-white bg-primary-500"
            aria-label="LinkedIn"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="-translate-y-0.5">
